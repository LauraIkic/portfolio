...
const Item = ({ project }: ProjectProps) => {
    ...
    return (
        <article className="flex flex-col md:flex-row group m-4 border border-[#DFDFDF] hover:border hover:border-secondary p-4 transition-all duration-300">
            <div className="w-full max-w-[250px] h-auto mb-4 md:mb-0 overflow-hidden">
                <Image
                    aria-hidden
                    src={image}
                    alt={title}
                    ...
                    className="object-cover transition-all duration-300 transform group-hover:scale-105 grayscale-[0.8] group-hover:grayscale-0"
                />
            </div>
